...
class XmsgeomConan(ConanFile):
    """XMSGeom Conanfile"""
    name = "xmsgeom"
    version = None
    license = "XMSNG Software License"
    url = "https://github.com/Aquaveo/xmsgeom"
    ...
    exports_sources = "xmsgeom/*", "test_files/*"
    ...
    def build(self):
        ...
        cmake.definitions["XMSGEOM_TEST_PATH"] = "test_files"
        ...
        if self.options.testing:
            ...
            with tools.pythonpath(self):
                ...
                self.run('python -m unittest discover -v -p *_pyt.py -s ../xmsgeom/python', cwd="./lib")

    def package(self):
        self.copy("*.h", dst="include/xmsgeom", src="xmsgeom")
    ...
    def package_info(self):
        ...
        if self.settings.build_type == 'Debug':
            self.cpp_info.libs = ["xmsgeom_d"]
        else:
            self.cpp_info.libs = ["xmsgeom"]
